...
exports.Api = Api;
},{"axios":"../node_modules/axios/index.js"}],"dragAndDrop/dragAndDrop.js":[function(require,module,exports) {
"use strict";
...
},{"../api":"api.js","../index":"index.js","../table/table":"table/table.js"}],"table/table.js":[function(require,module,exports) {
"use strict";
...
function removeMeeting(event) {
  ...
  _api.Api.delete("/events/".concat(_index.data[day][time].id)).then(function () {
    delete _index.data[day][time];
...
function render() {
  _api.Api.get('/events').then(function (res) {
    if (res.data === null) {
      renderTable(_index.data);
    } else {
      res.data.map(function (item) {
        ...
        var id = item.id;
        _index.data[parsedData.day][parsedData.time] = {
...
},{"../index":"index.js","../dragAndDrop/dragAndDrop":"dragAndDrop/dragAndDrop.js","../api":"api.js"}],"form/form.js":[function(require,module,exports) {
"use strict";
...
function pushMeeting(event) {
  ...
  if (Object.keys(_index.data[_index.selectedWeekDay]).includes(_index.selectedTime)) {
    ...
    _api.Api.post('/events', {
      data: JSON.stringify({
        title: meetingTitle.value,
        participants: _index.selectedParticipants,
        time: _index.selectedTime,
        day: _index.selectedWeekDay
      })
    });
...
},{"../api":"api.js","../index":"index.js","../table/table":"table/table.js"}],"form/loginForm.js":[function(require,module,exports) {
"use strict";
